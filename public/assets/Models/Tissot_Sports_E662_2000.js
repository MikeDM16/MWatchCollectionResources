export default {
  ...
  technicalData: {
    ...
    Movement: {
      Title: " ETA G10.211 ",
      Description:
        "ETA chronograph movement used in most of the Tissot quartz series like PRS 200, PRC 200, T-Race, V8, PRS 516 and Couturier models. \n \n" +
      ...
      UsefullLinks: {
        "Instruction Manual from ETA":
          "../Files/2798_ETA G10.211,G10.21A Operating Instructions.pdf",
        "Technical Information from ETA": "../Files/623_ETAG10.211,G10.21A.pdf",
      },
      sliderImages: [
        "public/assets/Images/Tissot/2000_Tissot_Sport_E662762M/eta-caliber-g10-211-3.JPG",
        "public/assets/Images/Tissot/2000_Tissot_Sport_E662762M/eta-caliber-g10-211-4.JPG",
        "public/assets/Images/Tissot/2000_Tissot_Sport_E662762M/eta-caliber-g10-211.JPG",
        "public/assets/Images/Tissot/2000_Tissot_Sport_E662762M/eta-caliber-g10-211-2.JPG",
      ],
      ...
      Details: {
        ...
        Functions:
          "Chrono up to 1/10 seconds, Date, Hours, Minutes, Seconds at 6 o´clock",
      },
    },
  },
};
