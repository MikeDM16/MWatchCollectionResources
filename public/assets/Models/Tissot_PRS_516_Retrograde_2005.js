export default {
  ...
  technicalData: {
    ...
    Information: {
      Brand: "Tissot",
      Series: "PRS 516",
      "Catalogue Reference": "J565/665 (T91.1.428.51)",
      "Prodution Year": "2005",
      Movement: "Quartz",
      Style: "Sports Watch",
    },
    ...
    Dial: {
      Color: "Black",
      "Dial markers": "Sticks",
      "Finishing Details": "Racing decoration",
    ...
    Movement: {
      ...
      UsefullLinks: {
        "Users Manual from Tissot":
          "../Files/Tissot Chronographs G15 Retrograde Users Manual.pdf",
        "Instruction Manual from ETA": "../Files/ETA_G15261_instruction.pdf",
        "Technical Information from ETA":
          "../Files/ETA_G15261_technical_info.pdf",
      },
      sliderImages: [
      ...
      Details: {
        Manufacturer: "ETA",
        "Caliber Number": "G15.261",
        Type: "Quartz",
        Battery: "394",
        Jewels: "6 (Six) Jewels ",
        Functions:
          "Retrograde Chronograph, Date, Hours, Minutes, Seconds at 6 o´clock",
      },
    },
  },
};
